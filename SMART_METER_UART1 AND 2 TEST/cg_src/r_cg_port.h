...
#define _00_PFSEG26_PORT                  (0x00U) /* used the P32 pin as port */
#define _04_PFSEG26_SEG                   (0x04U) /* used the P32 pin as segment output */
/* Port (other than segment output)/segment outputs specification of P33 pins (PFSEG27) */
#define _00_PFSEG27_PORT                  (0x00U) /* used the P33 pin as port */
#define _08_PFSEG27_SEG                   (0x08U) /* used the P33 pin as segment output */
/* Port (other than segment output)/segment outputs specification of P34 pins (PFSEG28) */
#define _00_PFSEG28_PORT                  (0x00U) /* used the P34 pin as port */
#define _10_PFSEG28_SEG                   (0x10U) /* used the P34 pin as segment output */
/* Port (other than segment output)/segment outputs specification of P35 pins (PFSEG29) */
#define _00_PFSEG29_PORT                  (0x00U) /* used the P35 pin as port */
#define _20_PFSEG29_SEG                   (0x20U) /* used the P35 pin as segment output */
/* Port (other than segment output)/segment outputs specification of P36 pins (PFSEG30) */
#define _00_PFSEG30_PORT                  (0x00U) /* used the P36 pin as port */
#define _40_PFSEG30_SEG                   (0x40U) /* used the P36 pin as segment output */
/* Port (other than segment output)/segment outputs specification of P37 pins (PFSEG31) */
#define _00_PFSEG31_PORT                  (0x00U) /* used the P37 pin as port */
#define _80_PFSEG31_SEG                   (0x80U) /* used the P37 pin as segment output */

/*
    LCD port function registers (PFSEG4) 
*/
/* Port (other than segment output)/segment outputs specification of P02 pins (PFSEG32) */
...
/* Port (other than segment output)/segment outputs specification of P03 pins (PFSEG33) */
...
/* Port (other than segment output)/segment outputs specification of P04 pins (PFSEG34) */
...
/* Port (other than segment output)/segment outputs specification of P05 pins (PFSEG35) */
...
/* Port (other than segment output)/segment outputs specification of P06 pins (PFSEG36) */
...
/* Port (other than segment output)/segment outputs specification of P07 pins (PFSEG37) */
