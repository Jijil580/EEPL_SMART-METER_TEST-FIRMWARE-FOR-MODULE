...
Typedef definitions
***********************************************************************************************************************/
extern uint8_t UART1_RECIEVED_DATA[100];
extern uint8_t UART1_SEND_DATA[100];
extern uint8_t RECIEVED_DATA_SIZE;
extern uint8_t UART2_RECIEVED_DATA[100];
extern uint8_t UART2_SEND_DATA[100];

extern uint8_t UART2_SEND_BUF[100];
/***********************************************************************************************************************
Global functions
***********************************************************************************************************************/
